...
const TestMode = ({ session }) => {
            ...
            try {
                ...
                if(data && data?.statusCode == 200) {
                    ...
                    if(!Object.keys(data?.data).length) {
                        ...
                        if(router.query.hasOwnProperty("selectedSections") && router.query.selectedSections.length) {
                            let paperData = data.data;
                            let updatedSections = await paperData.sections.filter((section) => section.compulsory === "Yes" || router.query.
                            selectedSections.includes(section._id));
                            allQuestions = updatedSections?.flatMap(section => section.questions);
                            let updatedPaperData = {...paperData, sections : updatedSections};
    ...
    const submitPaper = async (result) => {
        try {
            ...
            console.log(body,"payloadForTestResponse");
                                    ...
                                    <Grid container className={styles.paperContainer}>
                                        ...
                                        <Grid item xl={9} lg={7} sm={12} md={12} xs={12}>
                                            <Grid container className={styles.testQuestionAndSectionTitleContainer}>
                                                ...
                                                <Grid item xl={12} lg={12} sm={12} md={12} xs={12} className={styles.testQuestionActionButton}>
                                                    <Grid container>
                                                        <Grid item xl={12} lg={12} sm={12} md={12} xs={12}>
                                                            <Grid container>
                                                                <Grid item xl={12} lg={12} sm={12} md={12} xs={12}>
