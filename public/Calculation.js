...
$(document).ready(function () {
    ...
    $("div#keyPad a.keyPad_btnNumeric").click(function () {
        ...
        if(boolClear) {
			inBox.val(strEmpty); boolClear = false;
		}
        var str = inBox.val();
    ...
    $("div#keyPad a.keyPad_btnBinaryOp").click(function () {
        ...
        switch(this.id) {
			...
			case 'keyPad_btnOpen' : displayString= inBox1.val() + $("#"+this.id).text();
					...
					stackVal1 =1;
					break;
			case 'keyPad_btnClose' :if(stackVal2 == 6) {
		...
		if(opCode) {
			...
			stackVal = parseFloat(inBox.val()); boolClear = true; 
		}
        opCode = newOpCode;
        inBox.focus();
	...
	function displayTrignometric(text,x) {
		...
		if(stackVal2 == 2 || stackVal1 ==3) {
			if(stackVal2 ==3) {
				trigDisplay = text + "(" + x + ")" ; stackVal2 = 2; 
			} else {
